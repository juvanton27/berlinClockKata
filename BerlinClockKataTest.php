...
class BerlinClockKataTest extends TestCase
{
    ...
    public function test_clock_given00_00_00_shouldReturn1_0_0_0_0(){
        ...
        $this->assertEquals("1, 0, 0, 0, 0", $actual);
    }

    public function test_clock_given00_00_01_shouldReturn0_0_0_0_0(){
        $actual = $this->actClock(00,00,01);

        $this->assertEquals("0, 0, 0, 0, 0", $actual);
    }

    public function test_clock_given00_01_00_shouldReturn0_0_0_0_1(){
        $actual = $this->actClock(00,01,00);

        $this->assertEquals("1, 0, 0, 0, 1", $actual);
    }

    public function test_clock_given01_00_00_shouldReturn1_0_1_0_0(){
        $actual = $this->actClock(01,00,00);

        $this->assertEquals("1, 0, 1, 0, 0", $actual);
    }

    public function test_clock_given00_05_00_shouldReturn1_0_0_1_0(){
        $actual = $this->actClock(00,05,00);
    ...
    public function test_clock_given12_50_41_shouldReturn0_2_2_10_0(){
        $actual = $this->actClock(12, 50, 41);

        $this->assertEquals("0, 2, 2, 10, 0", $actual);
    }
